...
**Tags:** `testing`, `performance`, `load-testing`, `locust`, `development`
**Last updated:** 2025-11-14

Comprehensive load testing suite for the Cookbook Creator application, with special focus on the memory-intensive recipe upload feature. Uses Locust for distributed load testing with detailed performance metrics and reports.

---

## Overview

This load testing suite is designed to:
- Test memory-intensive recipe upload features
- Simulate concurrent users with realistic behavior patterns
- Provide comprehensive performance metrics and HTML reports
- Monitor memory usage during image processing
- Test OCR processing pipeline under load
...
### 1. Baseline Test
- **Users:** 10
- **Pattern:** Mix of uploads and browsing
- **Duration:** 5 minutes
- **Purpose:** Establish performance baseline

### 2. Stress Test
- **Users:** 50 concurrent users
- **Pattern:** Aggressive upload patterns
- **Duration:** 10 minutes
- **Purpose:** Find breaking point

### 3. Spike Test
- **Users:** Sudden increase from 5 to 50 users
- **Pattern:** Rapid ramp-up
- **Duration:** 5 minutes
- **Purpose:** Test system response to traffic spikes
...
### 5. Burst Pattern
- **Users:** Variable (5-30)
- **Pattern:** Random spikes in upload activity
- **Duration:** 15 minutes
- **Purpose:** Simulate real-world traffic patterns
