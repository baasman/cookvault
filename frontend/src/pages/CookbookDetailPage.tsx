                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-border-light z-20">
                        ...
                        >
                          ...
                          <span className="text-text-primary">Create New Recipe</span>
                        </button>
                        <button
                          onClick={() => {
                          ...
                          className="w-full text-left px-4 py-3 hover:bg-gray-50 flex items-center space-x-2 rounded-b-lg border-t border-border-light"
                        >
                          <svg className="h-5 w-5 text-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
