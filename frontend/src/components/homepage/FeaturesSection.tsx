  ...
  const features = [
    {
      ...
      description: "Our advanced OCR technology accurately extracts text from your handwritten or printed recipes, ensuring consistency in measurements and formatting for perfect results every time."
    },
    {
