                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {noteContent && (
                      <button
                        ...
                        disabled={isSaving}
                        className="px-4 py-2 border border-gray-300 bg-white text-gray-700 rounded-lg text-sm font-medium transition-colors hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Clear
                      </button>
                    )}
