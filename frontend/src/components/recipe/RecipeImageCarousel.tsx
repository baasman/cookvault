...
const RecipeImageCarousel: React.FC<RecipeImageCarouselProps> = ({ recipe, className = '', canEdit = false }) => {
  ...
  if (!sortedImages.length) {
    // No images - show minimal placeholder (not a huge square)
    return (
      <div className={`bg-gradient-to-br from-background-secondary to-primary-200 rounded-xl flex items-center justify-center py-8 ${className}`}>
