...
workers = int(
    os.environ.get("GUNICORN_WORKERS", min(multiprocessing.cpu_count(), 2))
)  # Cap at 2 workers for memory
worker_class = "sync"
worker_connections = 1000
timeout = int(
    os.environ.get("GUNICORN_TIMEOUT", 180)
)  # 3 minutes for heavy LLM+image processing
keepalive = 2
