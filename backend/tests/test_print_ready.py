...
def test_trim_size_mapping():
    ...
    try:
        ...
        print(f"  Trim dimensions: {dimensions.trim_width/72:.2f}\" x {dimensions.trim_height/72:.2f}\"")
        print(f"  Full dimensions: {dimensions.full_width/72:.2f}\" x {dimensions.full_height/72:.2f}\"")
        print(f"  Safe dimensions: {dimensions.safe_width/72:.2f}\" x {dimensions.safe_height/72:.2f}\"")
...
def test_pdf_config():
    ...
    try:
        ...
        print(f"✓ Print-ready mode enabled")
