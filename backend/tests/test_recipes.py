        ...
        with client.application.app_context():
            for i in range(15):
                ...
                instruction = Instruction(
                    recipe_id=recipe.id, step_number=1, text="Test instruction"
                )
...
class TestUploadRecipe:
    ...
    def test_upload_with_cookbook_info(
        self, mock_process, client: FlaskClient, sample_cookbook: Cookbook
    ) -> None:
        mock_process.return_value = None
    ...
    def test_upload_with_invalid_cookbook_id(
        self, mock_process, client: FlaskClient
    ) -> None:
        mock_process.return_value = None
