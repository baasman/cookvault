...
class ClassicCoverTemplate(CoverTemplate):
    ...
    def render_front_cover(
        ...
        # Subtitle/tagline if available
        subtitle = cookbook_data.get('subtitle') or cookbook_data.get('description', '')[:60]
        if subtitle:
        ...
        canvas.setStrokeColor(self.accent_color)
        canvas.setLineWidth(3)
        canvas.line(safe_area['left'], safe_area['bottom'] + 20, safe_area['right'], safe_area['bottom'] + 20)
    ...
    def render_back_cover(
        ...
        canvas.setStrokeColor(self.accent_color)
        canvas.setLineWidth(2)
        canvas.line(safe_area['left'], safe_area['top'] - 20, safe_area['right'], safe_area['top'] - 20)
