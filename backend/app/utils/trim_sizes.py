...
class TrimSizeMapper:
    ...
    @classmethod
    def get_gutter_margin(self, binding_type: str, page_count: int = None) -> float:
        """
    ...
    def calculate_spine_width(
        self, page_count: int, paper_type: str = "standard_white"
    ) -> float:
        """
    ...
    def _get_size_description(self, trim_size: TrimSize) -> str:
        ...
        return descriptions.get(
            trim_size, f"{trim_size.name} - Professional print size"
        )
