...
def upgrade():
    ...
    op.add_column(
        "instruction", sa.Column("image_filename", sa.String(255), nullable=True)
    )
    op.add_column("instruction", sa.Column("image_url", sa.String(500), nullable=True))
    op.add_column(
        "instruction", sa.Column("cloudinary_public_id", sa.String(255), nullable=True)
    )
    op.add_column(
        "instruction", sa.Column("cloudinary_url", sa.String(500), nullable=True)
    )
    op.add_column(
        "instruction",
