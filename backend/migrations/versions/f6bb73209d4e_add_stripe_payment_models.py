...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "tier", sa.Enum("FREE", "PREMIUM", name="subscriptiontier"), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_type",
            sa.Enum("SUBSCRIPTION", "COOKBOOK", name="paymenttype"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    with op.batch_alter_table("cookbook", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "is_purchasable", sa.Boolean(), nullable=False, server_default="0"
            )
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "purchase_count", sa.Integer(), nullable=False, server_default="0"
            )
        )
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_user_stripe_customer_id", ["stripe_customer_id"]
        )
