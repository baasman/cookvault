...
def upgrade():
    ...
    if is_sqlite:
        ...
        op.add_column('recipe', sa.Column('uploaded_by_id', sa.Integer(), nullable=True))
    ...
    op.execute('UPDATE recipe SET uploaded_by_id = user_id WHERE uploaded_by_id IS NULL')
