...
def upgrade():
    ...
    op.add_column(
        "recipe_image", sa.Column("cloudinary_public_id", sa.String(255), nullable=True)
    )
    op.add_column(
        "recipe_image", sa.Column("cloudinary_url", sa.String(500), nullable=True)
    )
    op.add_column(
        "recipe_image",
        sa.Column("cloudinary_thumbnail_url", sa.String(500), nullable=True),
    )
    op.add_column(
        "recipe_image", sa.Column("cloudinary_width", sa.Integer(), nullable=True)
    )
    op.add_column(
        "recipe_image", sa.Column("cloudinary_height", sa.Integer(), nullable=True)
    )
    op.add_column(
        "recipe_image", sa.Column("cloudinary_format", sa.String(10), nullable=True)
    )
    op.add_column(
        "recipe_image", sa.Column("cloudinary_bytes", sa.Integer(), nullable=True)
    )

    # Add index on cloudinary_public_id for faster lookups
    op.create_index(
        "idx_recipe_image_cloudinary_public_id",
        "recipe_image",
