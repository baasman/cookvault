...
def upgrade():
    ...
    with op.batch_alter_table('print_orders', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('refund_reason', sa.String(length=500), nullable=True))
        batch_op.add_column(sa.Column('stripe_refund_id', sa.String(length=255), nullable=True))
        ...
        batch_op.create_foreign_key('fk_print_orders_payment_id', 'payments', ['payment_id'], ['id'])
